...
tf.flags.DEFINE_string("output_dir", "./data_tfrecords", "Output data directory.")
...
def main(unused_argv):
    ...
    # image load
    image_data = []
    list = os.listdir(FLAGS.data_path)  # 列出文件夹下所有的目录与文件
    ...
    for i in range(0, len(list)):
        ...
        for image in list_image:
            ...
            image_data.append(ImageMetadata(int(list[i]), image_path))
